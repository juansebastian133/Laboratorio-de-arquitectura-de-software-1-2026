...
document.getElementById('form-find-customer').addEventListener('submit', async (event) => {
...
document.getElementById('form-create-customer').addEventListener('submit', async (event) => {
  event.preventDefault();
